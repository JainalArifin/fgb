            ...
            <Container className="detailStyle mb-5">
                <Row>
                    <Col md={4}>
                        ...
                        <h1 className="title-detail">{listData.title}</h1>
                    ...
                    <Col md={8}>
                        <img className="img-fluid img-detail shadow-lg" src={listData.imgToUrl} alt="img-detail"/>
                    </Col>
                </Row>
                <Row>
                    <Col md={12} className="mt-5">
                        <div className="desc">
                            <h1 className="title-detail mb-3">{listData.title}</h1>
